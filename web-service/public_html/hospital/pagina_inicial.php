...
<html lang="pt-br">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="pagina_inicial.php">Hospital</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="veiculos.php">Pacientes</a></li>
      </ul>
    ...
    <div class="container">   
     ...
     <form id="f_filtro" data-toggle="validator" role="form" method="post" name="escolha" action="<?php echo $_SERVER['PHP_SELF'];?>">
      ...
      <div class="form-group">
            <input name="chamaP" class="hidden"> 
       </div>
              ...
              <?php 
                ...
                if(isset($_POST['chamaP'])) {
                  ...
                  $dados=$conectar->query("SELECT * FROM veiculos");
                    ...
                    $modl=$linha['modelo'];
                    $catg=$linha['categoria'];
                    $prec=$linha['preco'];
                    $c_foto=$linha['caminho_foto'];    


                  echo "<h2>Modelo: ".$modl."</h2>";
                  echo "<br>";
                  echo "<h2>Categoria: ".$catg."</h2>";
                  echo "<br>";
                  echo "<h2>Preço: ".$prec."</h2>";
                  echo "<br>";
                  echo "<h2>Foto: ".$c_foto."</h2>";
                  echo "<br>";
                  echo "<p>Consulte condições de financiamento</p>";
                }
              ?>
