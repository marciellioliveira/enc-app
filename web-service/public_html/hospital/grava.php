<?php
  ...
  $conecta=new PDO('mysql:host=localhost;port=3306;dbname=id2085622_a','id2085622_root','encosto');
  $conecta->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

   $consulta = $conecta->query("SELECT * FROM funcionarios WHERE email='$em'");
   ...
   else
   {
      ...
      $textoSQL="INSERT INTO funcionarios(nome, sobrenome, email, senha) VALUES ('".$primnome."','".$segnome."','".$em."','".$se."')";  
